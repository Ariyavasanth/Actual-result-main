...
export class AdminScheduleTestComponent {
  ...
  schedule() {
    ...
    const payload: {
      ...
      multiple_review: !!this.model.multiplereview,
    ...
    try {
      ...
      if (rawEdit) {
        ...
        try {
          ...
          this.model.multiplereview = toBool(e.multiple_review ?? e.multiplereview ?? false);
        ...
        try {
          ...
          for (const c of reviewCandidates) { if (typeof c !== 'undefined') { this.model.userreview = toBool(c); break; } }
          this.model.multiplereview = toBool(v.multiple_review ?? v.multiplereview ?? false);
